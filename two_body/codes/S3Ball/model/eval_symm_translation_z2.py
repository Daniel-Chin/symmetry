...
RESULT_PATH = 'eval_symm_translation_z2/'
...
if __name__ == "__main__":
    ...
    # t1 = make_a_ndarray_batch(np.array([0.0, 0.0, -4.0]), BATCH_SIZE)
    # t2 = make_a_ndarray_batch(np.array([0.0, 0.0, -2.0]), BATCH_SIZE)
    # t3 = make_a_ndarray_batch(np.array([0.0, 0.0, 2.0]), BATCH_SIZE)
    # t4 = make_a_ndarray_batch(np.array([0.0, 0.0, 4.0]), BATCH_SIZE)

    t1 = make_a_ndarray_batch(np.array([0.0, 0.0, -0.2]), BATCH_SIZE)
    t2 = make_a_ndarray_batch(np.array([0.0, 0.0, -0.1]), BATCH_SIZE)
    t3 = make_a_ndarray_batch(np.array([0.0, 0.0, 0.1]), BATCH_SIZE)
    t4 = make_a_ndarray_batch(np.array([0.0, 0.0, 0.2]), BATCH_SIZE)
